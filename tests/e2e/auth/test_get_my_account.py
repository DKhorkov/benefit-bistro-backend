...
@pytest.mark.anyio
async def test_get_my_account_success(async_client, create_test_user_if_not_exists, cookies) -> None:
...
@pytest.mark.anyio
async def test_get_my_account_fail(async_client, create_test_user_if_not_exists) -> None:
